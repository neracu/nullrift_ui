...
export default function HeroSection() {
  return (
    <div className="relative w-full min-h-screen overflow-y-auto bg-zinc-950 font-sans text-white">
      <style>{`
                ...
                <div className="animate-marquee flex gap-12 whitespace-nowrap px-4">
                  {[...CLIENTS, ...CLIENTS, ...CLIENTS].map((client, i) => {
                    ...
                    return (
                      <div
                        key={`${client.name}-${i}`}
                        className="flex cursor-default items-center gap-2 opacity-50 grayscale transition-all hover:scale-105 hover:grayscale-0 hover:opacity-100"
                      >
                        <Icon className="h-6 w-6 fill-current text-white" />
